...
public class Ex11_AWT_Frame {
	public static void main(String[] args) {
		...
		//버튼을 클릭하면 행위 
		//메서드를 찿는다 : actionPerformed (button 클릭하면 호출 되는 함수) API
		//ActionListener 인터페이스가  actionPerformed 가지고 있다
		//이벤트 핸들러를 만들어야지 : ActionListener 구현하는 클래스  
		//actionPerformed 함수에 대한 구현 >> override 
		//Button 붙이기 (리스너를 통해서 등록하기)
		
		//행위 btn 클릭하면 사용 .. 필요없잖아 (1회성) >> 특정 btn 사용
